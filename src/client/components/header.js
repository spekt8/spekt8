...
const Header = () => (
  <div className="header">
    ...
    {/* <a href="https://github.com/spekt8/spekt8" className="github-corner">
      <svg width="80" height="80" viewBox="0 0 250 250" style="fill: #111; color: #EFEFEF; position: fixed; bottom: 0; border: 0; left: 0; transform: rotate(180deg)">
